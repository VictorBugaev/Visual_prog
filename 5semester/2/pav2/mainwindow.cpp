...
Material materials[] = {
    {QColor(0, 255, 255), 0.6},  // Стеклопакет
    {QColor(0, 0, 0), 0.7},  // IRR стекло
    {QColor(255, 240, 245), 0.8},  // Бетон
    {QColor(160, 82, 45), 0.9}  // Дерево\гипсокартон
};
    ...
    : QMainWindow(parent)
{
    ...
    add_material_to_map(map_obj, 600, 300, 50, 50, (int)type_material::IRR_GLASS);
    for (int i = 0; i < SIZE_MAP_Y; i++){
